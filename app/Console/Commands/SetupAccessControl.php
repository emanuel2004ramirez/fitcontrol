...
class SetupAccessControl extends Command
{
    ...
    private const ROLES = [
        ...
        'caja' => ['Caja', 'Cobros, pagos y consultas comerciales.', ['pagos.*', 'clientes.viewAny', 'clientes.view', 'membresias.viewAny', 'membresias.view', 'reportes.viewAny', 'reportes.view']],
        'entrenador' => ['Entrenador', 'Rutinas, ejercicios, evaluaciones y entrenamientos.', ['clientes.viewAny', 'clientes.view', 'ejercicios.*', 'rutinas.*', 'evaluaciones.*', 'entrenamientos.*', 'asistencias.viewAny', 'asistencias.view']],
    ];
